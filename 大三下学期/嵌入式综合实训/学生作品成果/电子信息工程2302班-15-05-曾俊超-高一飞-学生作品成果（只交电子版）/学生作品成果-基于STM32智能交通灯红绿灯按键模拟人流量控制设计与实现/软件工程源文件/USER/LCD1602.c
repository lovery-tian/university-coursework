...
void Lcd_GPIO_init(void)
{
    ...
    /********Data端口设置*************/
     ...
     GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_All;  //GPIO_DATA_0_PIN|GPIO_DATA_1_PIN|GPIO_DATA_2_PIN|GPIO_DATA_3_PIN|GPIO_DATA_4_PIN|GPIO_DATA_5_PIN|GPIO_DATA_6_PIN|GPIO_DATA_7_PIN; //  DB8~DB15
...
void Lcd_Busy(void)//判断忙
{
 unsigned int later0=0;
	 ...
	 SET_EN; //EN = 1
	 //delay_us(2);   
     while ((GPIO_ReadInputDataBit(GPIO_DATA_7,GPIO_DATA_7_PIN))&&(later0<20000)) 
	 {
	 	delay_us(5);
		later0++;	
	 }
